...
class Food extends StatefulWidget {
  ...
  Food({this.use_id, this.cat_name});
  @override
...
class _FoodState extends State<Food> {
  ...
  void getDataFood(int count, String strSearch) async {
    ...
    loadingList = true;
    setState(() {});
    print(' cate nam epage 2 : ${widget.use_id}');
    SharedPreferences sh = await SharedPreferences.getInstance();
    String use_id = sh.getString("use_id");

    List arr = await getData(count, "food/readfood_user.php",
        strSearch, "use_id=${use_id}&");
  ...
  void initState() {
    ...
    getDataFood(0, "");
    print(' cate nam epage 9 : ${widget.cat_name}');
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              AddFood(cat_name: widget.cat_name,
                              )));
