import 'package:dashboard/pages/account/changepassword.dart';
import 'package:dashboard/pages/account/forgetPassword.dart';
import 'package:dashboard/pages/account/login.dart';
import 'package:dashboard/pages/account/myprofile.dart';
...
class MyDrawer_use extends StatefulWidget {
	@override
	_MyDrawer_useState createState() => _MyDrawer_useState();
}

class _MyDrawer_useState extends State<MyDrawer_use> {
	void logout(context) {
		...
		Navigator.pushReplacement(
				context, MaterialPageRoute(builder: (context) => new Login_use()));
	}
