...
import 'package:dashboard/pages/test1/detail_billData.dart';
...
class _BillState extends State<Bill> {
	...
	void getDatabill(int count, String strSearch) async {
		loadingList = true;
		setState(() {});
		List arr = await getData_bill(
				count, 20, "bill/readdetail_bill_2.php", strSearch, "use_id=${G_use_id_val}&");
...
class SingleBill extends StatefulWidget {
	...
	var  use_id ;
	DetailBillData bill;
	SingleBill({this.det_index, this.use_id , this.bill});
