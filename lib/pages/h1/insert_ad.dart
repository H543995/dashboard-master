...
import 'package:dashboard/pages/h1/usrts_date_ad.dart';
...
class insert_ad extends StatefulWidget {
	final String cat_name;
       int use_id;

	insert_ad({ this.cat_name,this.use_id});

	@override
	_insert_adState createState() => _insert_adState();
}

class _insert_adState extends State<insert_ad> {
	...
	void getDataUser(int count, String strSearch) async {
		loadingList = true;
		setState(() {});
		List arr = await getData(count, "users/readuser.php?cat_name=${widget
				.cat_name}&", strSearch, "");
