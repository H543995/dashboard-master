...
class _UsersState extends State<Users> {
  ...
  void getDataUser(int count, String strSearch) async {
    loadingList = true;
    setState(() {});
    List arr = await getData(count, "users/readuser_ad.php", strSearch, "");
  ...
  Widget _appBarTitle = new Text("ادارة اصحاب المحلات");
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => AddUsers(cat_name:
                      widget.cat_name,
                         )));
                },
                child: Text(
