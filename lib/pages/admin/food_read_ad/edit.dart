...
import 'package:dashboard/pages/admin/food_read_ad/food_data.dart';
...
class EditFood_ad extends StatefulWidget {
  int foo_index;
  FoodData_ad myfood;

  EditFood_ad({this.foo_index, this.myfood});
  @override
  _EditFood_adState createState() => _EditFood_adState();
}

class _EditFood_adState extends State<EditFood_ad> {
  ...
  updateFood(context, LoadingControl load) async {
    ...
    if (txtfoo_name.text.isNotEmpty &&
      ...
      bool res = await uploadFileWithData(
          _image, arr, "admin/food_all_users/update_food.php", context, null, "update");
