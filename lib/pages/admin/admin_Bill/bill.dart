import 'dart:ui';
import 'package:dashboard/pages/admin/admin_Bill/detail_bill.dart';
...
class Bill_ad extends StatefulWidget {
  @override
  _Bill_adState createState() => _Bill_adState();
}

class _Bill_adState extends State<Bill_ad> {
  ...
  void getDatabill(int count, String strSearch) async {
    ...
    List arr = await getData2(
        count, 20, "bill/readbill_ad.php", strSearch, "");
