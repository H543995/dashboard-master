...
class DetailBill_ad extends StatefulWidget {
  final String bil_id;
  final String bil_regdate;
  DetailBill_ad({this.bil_id, this.bil_regdate});
  @override
  _BillState createState() => _BillState();
}

class _BillState extends State<DetailBill_ad> {
  ...
  void getDatabill(int count, String strSearch) async {
    loadingList = true;
    setState(() {});
    List arr = await getData2(count, 20, "bill/readdetail_bill.php", strSearch,
