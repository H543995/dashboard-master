...
import 'package:dashboard/pages/admin/category_admin/category_data_admin.dart';
...
class EditCategory_ad extends StatefulWidget {
	int cat_index;
	CategoryData_ad mycategory;

	EditCategory_ad({this.cat_index, this.mycategory});
	@override
	_EditCategory_adState createState() => _EditCategory_adState();
}

class _EditCategory_adState extends State<EditCategory_ad> {
	...
	updateCategory(context, LoadingControl load) async {
		...
		if (txtcat_name.text.isNotEmpty &&
			...
			bool res = await uploadFileWithData(
					_image, arr, "admin/category_admin/update_category.php", context,
					null, "update");
